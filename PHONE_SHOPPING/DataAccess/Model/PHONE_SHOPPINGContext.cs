...
{
    public partial class PHONE_SHOPPINGContext : DbContext
    {
        public PHONE_SHOPPINGContext()
        {
        }

        public PHONE_SHOPPINGContext(DbContextOptions<PHONE_SHOPPINGContext> options)
            : base(options)
        {
        }
